...
private Solution solution = new IterativeSolution();
	...
	@Test
	public void testNoneOverapplingCycleList_itShouldReturn_expected()
	{
		final Node list1 = buildList(1, 2, 3, 4, 5, 6, 7, 8);
		findNode(8, list1).next = list1;
		final Node list2 = buildList(1, 2, 3, 4, 5, 6, 7, 8);
		findNode(8, list2).next = list2;
	...
	@Test
	public void testOverapplingBeforeCycle_itShouldReturn_expected()
	{
		final Node list1 = buildList(1, 2, 3, 4, 5, 6, 7, 8);
		findNode(8, list1).next = findNode(6, list1);
		final Node list2 = buildList(1, 2, 3, 4);
		findNode(4, list2).next = findNode(5, list1);
		assertThat(solution.findOverlapping(list1, list2), equalTo(findNode(5, list1)));
	}
	...
	@Test
	public void testOverapplingAtFirstCycle_itShouldReturn_expected()
	{
		final Node list1 = buildList(1, 2, 3, 4, 5, 6, 7, 8);
		findNode(8, list1).next = findNode(5, list1);
		final Node list2 = buildList(1, 2, 3, 4);
		findNode(4, list2).next = findNode(5, list1);
		assertThat(solution.findOverlapping(list1, list2), equalTo(findNode(5, list1)));
	}
	...
	@Test
	public void testOverapplingInCycle_itShouldReturn_expected()
	{
		final Node list1 = buildList(1, 2, 3, 4, 5, 6, 7, 8);
		findNode(8, list1).next = findNode(1, list1);
		final Node list2 = buildList(1, 2, 3, 4);
		findNode(4, list2).next = findNode(5, list1);
		assertThat(solution.findOverlapping(list1, list2), anyOf(equalTo(findNode(5, list1)), equalTo(findNode(1, list1))));
	}
}
