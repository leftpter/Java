...
public class IterativeSolutionTest
{
    ...
    {
        assertThat(solution.geteSuccessor(root, 19), sameInstance(root.right.left));
    }
	
	@Test
    public void test2_itShould_returnExpect()
    {
        assertThat(solution.geteSuccessor(root, 2), sameInstance(root.left.left));
    }
    ...
    {
        assertThat(solution.geteSuccessor(root, 17), sameInstance(root));
    }
}
